...
2. Apply Gödel's Incompleteness Theorems as meta-constraints:
...
- 6 specialized philosophical/systems reviewers:
  - Logical Consistency Reviewer (Gödelian analysis)
...
[From the Logical Consistency Reviewer - Gödelian concerns, self-reference issues]
